		 ...
		 <div class="col colum-f">
        	...
        	<table>
                ...
                <tr>
                        ...
                        <td class="hidden" contenteditable="false" data-name="url"><?php url::action('actions', "comment/update/$item->id"); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                        ...
                        <td contenteditable="true" data-name="name"><?php page::render($item->author); ?>
</td>
                </tr>
                <tr>
                	<td><?php lang::output('tab_authaddr'); ?></td>
                ...
                <tr>
                        ...
                        <td>
                        		<a href="<?php url::action('actions', "comment/delete/$item->id"); ?>" id="confirm" data-lang="<?php lang::output('text_confirm'); ?>"><?php lang::output('text_delete'); ?></a> 
                                </td>
